...
from tensorflow_probability.python.bijectors._numpy import affine_scalar as affine_scalar_bijector
...
from tensorflow_probability.python.bijectors._numpy import sinh_arcsinh as sinh_arcsinh_bijector
