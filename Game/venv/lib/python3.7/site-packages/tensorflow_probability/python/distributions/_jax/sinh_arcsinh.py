...
from tensorflow_probability.python.bijectors._jax import affine_scalar as affine_scalar_bijector
...
from tensorflow_probability.python.bijectors._jax import sinh_arcsinh as sinh_arcsinh_bijector
