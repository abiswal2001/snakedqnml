...
from tensorflow_probability.python.bijectors._numpy import cholesky_outer_product
...
from tensorflow_probability.python.math.psd_kernels._numpy import positive_semidefinite_kernel as psd_kernel
