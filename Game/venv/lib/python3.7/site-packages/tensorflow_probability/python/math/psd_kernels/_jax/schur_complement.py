...
from tensorflow_probability.python.bijectors._jax import cholesky_outer_product
...
from tensorflow_probability.python.math.psd_kernels._jax import positive_semidefinite_kernel as psd_kernel
